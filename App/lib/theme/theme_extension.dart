...
extension ThemeExtension on BuildContext {
  ...
  PinTheme get defaultPinTheme => theme.extension<CustomThemeExtension>()!.customPinTheme.defaultPinTheme;
  PinTheme get focusedPinTheme => theme.extension<CustomThemeExtension>()!.customPinTheme.focusedPinTheme;
  PinTheme get errorPinTheme => theme.extension<CustomThemeExtension>()!.customPinTheme.errorPinTheme;
  int get pinputLength => theme.extension<CustomThemeExtension>()!.customPinTheme.pinputLength;
  bool get showPinputCursor => theme.extension<CustomThemeExtension>()!.customPinTheme.showPinputCursor;
  Widget get pinputSeparator => theme.extension<CustomThemeExtension>()!.customPinTheme.pinputSeparator;
  TextStyle get pinputErrorTextStyle => theme.extension<CustomThemeExtension>()!.customPinTheme.pinputErrorTextStyle;
  Widget get pinputCursor => theme.extension<CustomThemeExtension>()!.customPinTheme.pinputCursor;
