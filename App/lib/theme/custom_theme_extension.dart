...
class CustomThemeExtension extends ThemeExtension<CustomThemeExtension> {
  //Pinput
  final CustomPinTheme customPinTheme;
  //gradientLoader
  ...
  CustomThemeExtension copyWith({
    ...
    return CustomThemeExtension(
      customPinTheme: customPinTheme ?? this.customPinTheme,
...
class CustomPinTheme {
  ...
  final int pinputLength;
  final bool showPinputCursor;
  final Widget pinputSeparator;
  final TextStyle pinputErrorTextStyle;
  final Widget pinputCursor;

  CustomPinTheme({
    required this.defaultPinTheme,
    required this.focusedPinTheme,
    required this.errorPinTheme,
    required this.pinputLength,
    required this.showPinputCursor,
    required this.pinputSeparator,
    required this.pinputErrorTextStyle,
    required this.pinputCursor,
  });
}
